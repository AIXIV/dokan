...
#define DOKAN_GLOBAL_DEVICE_TYPE FILE_DEVICE_DISK_FILE_SYSTEM

#define IOCTL_TEST \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x800, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_SET_DEBUG_MODE \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x801, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_EVENT_WAIT \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x802, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_EVENT_INFO \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_EVENT_RELEASE \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x804, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_EVENT_START \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x805, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_EVENT_WRITE \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x806, METHOD_OUT_DIRECT, FILE_ANY_ACCESS)

#define IOCTL_KEEPALIVE \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x809, METHOD_NEITHER, FILE_ANY_ACCESS)

#define IOCTL_SERVICE_WAIT \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x80A, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_RESET_TIMEOUT \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x80B, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_GET_ACCESS_TOKEN \
	CTL_CODE(DOKAN_GLOBAL_DEVICE_TYPE, 0x80C, METHOD_BUFFERED, FILE_ANY_ACCESS)
